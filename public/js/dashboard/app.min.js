...
!function(r) {
    function e() {
        ...
        r("[data-password]").on("click", function() {
            "false" == r(this).attr("data-password") ? (r(this).siblings("input").attr("type", "text"),
            r(this).attr("data-password", "true"),
            r(this).addClass("show-password")) : (r(this).siblings("input").attr("type", "password"),
            r(this).attr("data-password", "false"),
            r(this).removeClass("show-password"))
        }),
        r(".dropdown-menu a.dropdown-toggle").on("click", function(e) {
            return r(this).next().hasClass("show") || r(this).parents(".dropdown-menu").first().find(".show").removeClass("show"),
            r(this).next(".dropdown-menu").toggleClass("show"),
            !1
        }),
        Waves.init(),
        feather.replace()
    ...
    r(".dropdown-menu a.dropdown-toggle").on("click", function() {
        ...
        t.parent().find(".dropdown-toggle").removeClass("show"),
        !1
    }),
    t = r(".navbar-custom .dropdown:not(.app-search)"),
    r(document).on("click", function(e) {
        return "top-search" == e.target.id || e.target.closest("#search-dropdown") ? r("#search-dropdown").addClass("d-block") : r("#search-dropdown").removeClass("d-block"),
        !0
    }),
    r("#top-search").on("focus", function(e) {
        return e.preventDefault(),
        t.children(".dropdown-menu.show").removeClass("show"),
        r("#search-dropdown").addClass("d-block"),
        !1
    }),
    ...
    jQuery().mask && r('[data-toggle="input-mask"]').each(function(e, t) {
...
var ThemeCustomizer = function() {
    ...
    return _createClass(e, [{
        ...
        value: function() {
            ...
            $(".menu").length && (o = $(".menu li .collapse"),
            ...
            $(".menu a").each(function() {
                ...
                this.href == a && ($(this).addClass("active"),
            ...
            $("#two-col-sidenav-main").length && (n = $("#two-col-sidenav-main .menu-link"),
            ...
            n.on("click", function(e) {
                ...
                return t.length && (e.preventDefault(),
                n.removeClass("active"),
                $(this).addClass("active"),
                a.removeClass("d-block"),
                t.addClass("d-block"),
                1040 <= window.innerWidth && i.changeLeftbarSize("default")),
                !0
            }),
            ...
            setTimeout(function() {
                ...
                null != a && (e = document.querySelector(".app-menu .simplebar-content-wrapper"),
                t = a.offsetTop - 300,
                e && 100 < t && (n = t,
                i = 600,
                c = (r = e).scrollTop,
                ...
                function e() {
                    ...
                    n = c,
                    a = s,
                    (t /= i / 2) < 1 ? a / 2 * t * t + n : -a / 2 * (--t * (t - 2) - 1) + n);
                    r.scrollTop = o,
                    l < i && setTimeout(e, 20)
                }()))
            }, 200)
        ...
        value: function(e, t) {
            var n = !(1 < arguments.length && void 0 !== t) || t;
            this.html.setAttribute("data-menu-icon", e),
            n && (this.config.menu.icon = e,
            this.setSwitchFromConfig())
        }
    }, {
        key: "changeMenuColor",
        ...
        value: function(e, t) {
            ...
            n && (this.config.sidenav.size = e,
            this.setSwitchFromConfig())
        }
    }, {
        key: "changeTwocolumnColor",
        value: function(e) {
            this.html.setAttribute("data-two-column-color", e),
            this.config.sidenav.twocolumn = e,
            this.setSwitchFromConfig()
        }
    }, {
        ...
        value: function() {
            ...
            "rtl" != (null === (e = document.getElementsByTagName("html")[0]) || void 0 === e ? void 0 : e.getAttribute("dir")) && (document.body.style.overflow = "hidden",
            1140 < window.innerWidth && (document.body.style.paddingRight = "15px"));
            var n = this;
        ...
        value: function() {
            ...
            l && (e = document.querySelector("input[type=checkbox][name=data-bs-theme][value=" + l.theme + "]"),
