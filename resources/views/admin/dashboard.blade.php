    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">SAMS | Admin | Dashboard</h4>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="text-end">
                                ...
                                <p class="text-muted mb-1 text-truncate">Total Student</p>
                            </div>
                        </div>
                    </div> <!-- end row-->
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="text-end">
                                ...
                                <p class="text-muted mb-1 text-truncate">Unactive Students</p>
                            </div>
                        </div>
                    </div> <!-- end row-->
                </div>
